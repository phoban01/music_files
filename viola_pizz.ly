...
r64
\pizz_head "IV" \ppos #0.25 c64 \effort mf
...
\dxy #'(-1 . 3)
\pizz_head "III" \ppos #0.2 c64 \effort sfz
...
\arp_pizz_head "III" "I" \ppos #0 c32 \effort mf \>
\arp_pizz_head "III" "I" \ppos #0.5 c32
\tuplet 3/2 {
	\pizz_head "IV" \ppos #1.1 c32
	\pizz_head "II" \ppos #0.9 c32
	\pizz_head "III" \ppos #0.8 c32 \pp
}
r32 ]
...
\pizz_head "IV" \ppos #1.2 c32 [ \effort "f"
...
r32
\pizz_head "III IV" \ppos #1.2 c32 \mf
]
...
\tuplet 6/4 {
	\pizz_head "IV" \ppos #0.05 c32 [ \effort p
	\pizz_head "III" \ppos #0.2 c32
...
\pizz_head "II III IV" \ppos #0.95 c16 ] \mp
...
\arp_pizz_head "I" "III" \ppos #0.95 c8 \effort "f"
...
\tuplet 3/2 {
 ...
 \tuplet 3/2 {
	...
	\tuplet 3/2 {
		...
		\pizz_head "III" \ppos #0.25 c32 \effort mf
		\pizz_head "I" \ppos #0.1 c32 ] 
	}
 } 
...
\pizz_head "II" \ppos #0.075 c32 ]
 ...
 %%%%%%%% ============= measure 21 ============= %%%%%%%% 
\time 4/8
\pizz_head "I II III" \ppos #0.35 c16 [ \pp
\pizz_head "IV" \ppos #1.2 c32 \effort mf
\pizz_head "II" \ppos #1.2 c32
\tuplet 3/2 {
...
\tuplet 3/2 {
 ...
 \draw_bracket \fingernail
 \tuplet 3/2 {
 	\pizz_head "I" \ppos #0.1 c16 [ \effort "f" \startTextSpan
 	\pizz_head "II" \ppos #0.15 c16 \stopTextSpan
 	\pizz_head "II III" \ppos #0.9 c8 \mf
...
\arp_pizz_head "I" "IV" \ppos #0.1 c16 \effort "p"
 ...
 \pizz_head "I" \ppos #0.15 c32 [ \effort mf
 \pizz_head "IV" \ppos #0.5 c32 \p
 ...
 %%%%%%%% ============= measure 27 ============= %%%%%%%% 
  ...
  \pizz_head "III" \ppos #1.25 c16 [ \effort p
...
\pizz_head "II" \ppos #0.0 c16 ] \effort p
...
\tuplet 3/2 {
	\pizz_head "III" \ppos #0.5 c16 [ \mp
 	...
 	\pizz_head "I II" \ppos #1.25 c32 \effort mf
 }
...
\time 5/16
	\pizz_head "II III" \ppos #0.95 c8 [ \p
 ...
 %%%%%%%% ============= measure 37 ============= %%%%%%%% 
  ...
  \pizz_head "III IV" \ppos #0.2 c16 ] \effort p
 ...
 %%%%%%%% ============= measure 38 ============= %%%%%%%% 
  ...
  r16. [
  \pizz_head "I II III" \ppos #0.7 c32 ] \mf
...
\time 3/8
 ...
 %%%%%%%% ============= measure 41 ============= %%%%%%%% 
  \time 4/8
  	\pizz_head "IV" \ppos #0.45 c32 [ \effort "f"
  	\pizz_head "II" \ppos #0.4 c32 \effort p
  	\pizz_head "II" \ppos #0.35 c32 \effort "f"
  	\pizz_head "I" \ppos #0.3 c32  \effort p

  	\pizz_head "II III" \ppos #0.6 c16.. \mp
  	\arp_pizz_head "I" "IV" \ppos #-0.1 c64 ] \effort sfz

  	\tuplet 3/2 {
  		\arp_pizz_head "IV" "I" \ppos #-0.1 c16. [ 
		\pizz_head "I II III" \ppos #0.5 c32 \p
		\pizz_head "IV" \ppos #0.65 c16 \mf
  	}
 ...
 %%%%%%%% ============= measure 42 ============= %%%%%%%% 
  ...
  \tuplet 3/2 {
  	...
  	\pizz_head "II" \ppos #0.9 c32 \mf
  	\pizz_head "I" \ppos #1.15 c32 
  }
...
\tuplet 3/2 {
  ...
  r8. [
  \arp_pizz_head "I" "IV" \ppos #-0.15 c32. \effort p
  \pizz_head "IV" \ppos #0.65 c64 ] \f
  

 %%%%%%%% ============= measure 47 ============= %%%%%%%% 
  \time 5/8
  \tuplet 5/4 {
  	\pizz_head "I II III" \ppos #0.5 c16 [ \p
  ...
  \pizz_head "II III" \ppos #0.2 c8 [ \effort "f"
  \pizz_head "II III IV" \ppos #0.8 c16. \f
  \pizz_head "IV" \ppos #0.1 c32 ] \effort p
 ...
 %%%%%%%% ============= measure 49 ============= %%%%%%%% 
  ...
  \pizz_head "II III" \ppos #0.7 c16. \p
 ...
 %%%%%%%% ============= measure 63 ============= %%%%%%%% 
  ...
  \tuplet 3/2 {
  	\pizz_head "I II" \ppos #0.1 c16 \effort sfz
  	\pizz_head "III" \ppos #0 c16 \effort "f"
  	\arp_pizz_head "I" "IV" \ppos #0.6 c16 \mf
  }
  \pizz_head "III IV" \ppos #0.65 c16 \p
  \pizz_head "IV" \ppos #1.15 c16 ] \effort "f"
 ...
 %%%%%%%% ============= measure 64 ============= %%%%%%%% 
  ...
  \pizz_head "II" \ppos #1.1 c32 ] \effort mf
 ...
 r16
 \arp_pizz_head "II" "IV" \ppos #0 c16 \effort "f"
 ...
 %%%%%%%% ============= measure 76 ============= %%%%%%%% 
  ...
  \pizz_head "I" \ppos #0.05 c32
  r16
  \pizz_head "III IV" \ppos #0.6 c16 \f
  \pizz_head "II" \ppos #0.6 c32 \p
  \pizz_head "I" \ppos #0.65 c32
 ...
 %%%%%%%% ============= measure 77 ============= %%%%%%%% 
  ...
  \pizz_head "II III IV" \ppos #0.3 c8 [ \mp
  \pizz_head "I" \ppos #0.8 c8 \sfz
 ...
 %%%%%%%% ============= measure 87 ============= %%%%%%%% 
  ...
  \tuplet 5/4  {
  	r16
  	\pizz_head "III" \ppos #0.3 c32 \effort p
 ...
 %%%%%%%% ============= measure 92 ============= %%%%%%%% 
  ...
  r16
  \arp_pizz_head "IV" "I" \ppos #0.2 c16 \effort sfz
  r16
  \pizz_head "I II" \ppos #0.7 c16 ] \mf
 ...
 %%%%%%%% ============= measure 95 ============= %%%%%%%% 
  ...
  \pizz_head "IV" \ppos #1.15 c16 \effort p
  r16
  \pizz_head "I" \ppos #0 c16 ] \effort mf
 ...
 r16
  \arp_pizz_head "I" "IV" \ppos #0.4 c16 ] \sfz
 ...
 %%%%%%%% ============= measure 106 ============= %%%%%%%% 
  ...
  \tuplet 3/2 {
  	...
  	\pizz_head "III" \ppos #0.5 c16 \p
  	\pizz_head "IV" \ppos #1.1 c16 \effort "f"
  }
  ...
  \tuplet 5/4 {
  	r16
  	\pizz_head "II" \ppos #0.0 c32 \effort mf
 ...
 %%%%%%%% ============= measure 110 ============= %%%%%%%% 
  \time 4/8
  	\tuplet 5/4 {
	  	...
	  	\pizz_head "I II" \ppos #0.0 c8 \effort mf
	  	r8
	  	\pizz_head "III" \ppos #0.7 c8 \p
	  	\tuplet 3/2 {
...
%  \time 4/8
 ...
 \afterGrace \ppos #0.45 c16 ] \glissando
 	_\markup {
...
%  \time 9/16
 ...
 \afterGrace \ppos #0.3 c16 \glissando 
 	_\markup {
 			\override #'(extender-I . (#t . "release"))
...
\afterGrace \ppos #0.9 c16 \glissando {\slash_grace \ppos #0.4 c8}
\ppos #0.75 c16 \glissando
...
%  \time 7/16
 \tuplet 5/4 {
 	\afterGrace \ppos #0.375 c16 [ \glissando
 		...
 		{\slash_grace \ppos #0.15 c8}
 	\afterGrace \ppos #0.45 c8 \glissando {\slash_grace \ppos #0.75 c8}
 	\ppos #0.65 c16 \glissando
 		_\markup {
 				\fingering-diagram #'(("mute" . 0.2) ("mute" . 0.4) ("mute" . 0.6) (#f . 0.5))
 		}
 	\afterGrace \ppos #0.25 c16 \glissando {\slash_grace \ppos #0.35 c8}
 } 
...
%  \time 3/8
 ...
 \afterGrace \ppos #0.425 c8 ] \glissando
...
%   \time 5/4
  ...
  \afterGrace \ppos #0.7 c8 [ \glissando {\slash_grace \ppos #0.075 c8}
  \ppos #0.35 c8 ] \glissando
  		_\markup {
...
%  \time 4/8
 ...
 \glissSkipOff \afterGrace \ppos #0.2 c16 ] \glissando {\slash_grace \ppos #0.45 c8}
...
%   \time 3/4
  ...
  \tuplet 3/2 {
  	...
  	\glissSkipOn \afterGrace c8 \glissando {\glissSkipOff \slash_grace \ppos #0.35 c8}
  }
  r8.
  \ppos #0.5 c16 ] \glissando
  	_\markup {
...
%   \time 5/8
  ...
  \afterGrace \ppos #0.6 c16 \glissando {\slash_grace \ppos #0.05 c8}
...
%   \time 6/8
  ...
  \afterGrace \ppos #0.4 c8 \glissando 
  	...
  	{\slash_grace \ppos #0.1 c8}
  \afterGrace \ppos #0.3 c8 \glissando {\slash_grace \ppos #0.55 c8}
  \ppos #0.3 c8 \glissando
  	_\markup {
  			\fingering-diagram #'(("dot" . 0.5) ("dot" . 0.5) ("dot" . 0.5) ("dot" . 0.5))
  	}
...
%   \time 6/8
  ...
  \afterGrace \ppos #0.5 c16 \glissando {\slash_grace \ppos #0.1 c8}
  \ppos #0.25 c16 \glissando
  	_\markup {
  			\override #'(extender-IV . (#t . "dot"))
  			\fingering-diagram #'(("mute" . 0.8) ("mute" . 0.6) ("mute" . 0.4) ("mute" . 0.2))
 ...
 c8 \glissando 
 \glissSkipOff  \afterGrace \ppos #0.6 c8 \glissando
 	{\slash_grace \ppos #0.3 c8}
