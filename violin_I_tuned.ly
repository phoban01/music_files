 ...
 %%%%%%%% ============= measure 1 ============= %%%%%%%% 
	...
	>>
	 ...
	 << {cs'8 \pp ^\flat_bow ^\circular_bow ^\markup \string-numbers #'( "IV" 0 0) \glissando}  \\ {} >>
	  ...
	  \set Staff.forceClef = ##t
	  \draw_line_arrow \down_bow_light \down_bow_heavy
	  \niente \ppos #0.75 c'8 \< ~ ^\tilt_bow ^\frog \startTextSpan
	  %%%%%%%%%% measure 13 %%%%%%%%%%
	  \time 2/4
	  \ppos #0.75 c'8. [ 
	  \glissando 
...
%  	\wavy_vibrato #1.5
 	...
 	\time 2/4
 	\niente
 	\ppos #0.35 c'8 \< ^\aldita ^\down_bow_light ^\horz_bow ^\markup \string-numbers #'( "IV" 3 0)
 		\glissando \glissSkipOn 
 		\ppos #0.5 c'8 \p ^\vertical_bow
 			\glissando  \glissSkipOff 
 		\ppos #0.75 c'8 \< ^\horz_bow
 		\glissando 
 	\afterGrace \ppos #0.9 c'8 {s8 \sfz}
 	%%%%%%%%%% measure 108 %%%%%%%%%%
 	\time 5/4
 	\switch-staff \normal_staff
...
%  	\wavy_vibrato #1 
 	...
 	\body-clef #'fingerboard-small
 	\set Staff.forceClef = ##t
 	\ppos #0.2 c'4. ~ \effort mf ^\down_bow_light ^\nutharm ^\markup {\small \italic "(*Try to bow all strings simultaneously)"}
 		
 	\once \override Staff.TimeSignature.whiteout = ##t
 	%%%%%%%%%% measure 111 %%%%%%%%%%
 	\time 5/4
 	\ppos #0.2 c'8  \ppos #0.2 c'8 ~ ^\up_bow_light \ppos #0.2 c'4 ~ \ppos #0.2 c'8. \ppos #0.2 c'16 ~ ^\down_bow_light
 	\ppos #0.2 c'4 ~ \ppos #0.2 c'8. \ppos #0.2 c'16 ~
 	%%%%%%%%%% measure 112 %%%%%%%%%%
 	\time 2/4
 	\ppos #0.2 c'4 ~ \ppos #0.2 c'8 \ppos #0.2 c'8 ~ ^\up_bow_light
 	%%%%%%%%%% measure 113 %%%%%%%%%%
 	\time 3/8
 	\ppos #0.2 c'4.
 	%%%%%%%%%% measure 114 %%%%%%%%%%
 	...
 	\ppos #0.2 c'4 ~ \ppos #0.2 c'4 ~ \ppos #0.2 c'8 \ppos #0.2 c'8 ~ ^\up_bow_light
 	%%%%%%%%%% measure 116 %%%%%%%%%%
 	\time 3/8
 	\ppos #0.2 c'16 ~ \ppos #0.2 c'16 ~ \flare_width \afterGrace \ppos #0.2 c'16 \< ~ {\ppos #0.2 c'8 \flare_sf } r8.
 	%%%%%%%%%% measure 117 %%%%%%%%%%
 	\time 5/16
 	\ppos #0.2 c'8. \effort mf ~ \stemDown \afterGrace \ppos #0.2 c'16 [ ^\vertical_bow \glissando {\ppos #0.75 c'8} 
 	\ppos #0.2 c'16 \effort p ] ~ ^\horz_bow ^\down_bow_light
 	\stemNeutral
 	%%%%%%%%%% measure 118 %%%%%%%%%%
 	\time 2/4
	...
	\body-clef #'fingerboard-small
	\set Staff.forceClef = ##t
	\ppos #0.3 c'8 \glissando \effort mf ^\down_bow_light ^\markup {\small \italic "(*Try to bow all strings simultaneously)"}
	...
	\ppos #0.3 c'4 ~ \ppos #0.3 c'8 [ ~ \ppos #0.3 c'8 ] ^\down_bow_light
				^\markup {
					\fingering-diagram #'(("di" . 0.5) ("di" . 0.5) ("di" . 0.5) ("di" . 0.5))
			}
	%%%%%%%%%% measure 135 %%%%%%%%%%
...
% 	\wavy_vibrato #1 
	...
	\pizz_head "II III" \ppos #0.4 c4 ~ \mp ^\circular_bow
	\niente \afterGrace
