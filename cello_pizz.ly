...
\set baseMoment = #(ly:make-moment 1/8)
 ...
 %%%%%%%% ============= measure 75 ============= %%%%%%%% 
  \time 7/8
  \tuplet 6/4 {
  	\pizz_head "II" \ppos #0 c16 [ \effort mf
  	\pizz_head "I" \ppos #0.1 c16
  	\pizz_head "III" \ppos #0 c16
  	\pizz_head "IV" \ppos #0.125 c16 \< %>
  	\pizz_head "III" \ppos #0.2 c16
  	\pizz_head "I" \ppos #0.25 c16 \effort "f"
  }

  \arp_pizz_head "I" "IV" \ppos #0.375 c8 \mf
  ...
  \pizz_head "IV" \ppos #0.6 c8 \p

  \pizz_head "I II" \ppos #0.25 c16. \sfz
 ...
 %%%%%%%% ============= measure 76 ============= %%%%%%%% 
  ...
  r8 [
  \tuplet 3/2 {
  	\pizz_head "III" \ppos #0.25 c16 \mf
  	\pizz_head "II" \ppos #0.35 c16
  	\pizz_head "I" \ppos #0.5 c16 \f
  }
  \pizz_head "IV" \ppos #0.75 c16 \p
  \pizz_head "III" \ppos #0.55 c16 \f
 ...
 %%%%%%%% ============= measure 81 ============= %%%%%%%% 
  \time 2/8
  \pizz_head "I" \ppos #0.25 c32. [ \p 
  \pizz_head "II" \ppos #0.4 c16 \mf
  \arp_pizz_head "I" "IV" \ppos #-0.15 c64 \effort p
  
  r16
  \pizz_head "II III" \ppos #0.7 c16 ] \pp
...
cello_pizz_left = { 
 ...
 %%%%%%%% ============= measure 76 ============= %%%%%%%% 
  ...
  \afterGrace \ppos #0.1 c8 \glissando 
  	_\markup {
  			\fingering-diagram #'(("mute" . 0.2) ("dot" . 0.4) ("mute" . 0.6) ("mute" . 0.8))
  	}
  	{\slash_grace \ppos #0.3 c8}
  \ppos #0.45 c16 \glissando
  \afterGrace \ppos #0.3 c16 \glissando {\slash_grace \ppos #0.55 c8}
  r8 r8
  \ppos #0.3 c8 ] \glissando
  	_\markup {
  			\fingering-diagram #'((#f . 0.5) ("mute" . 0.25) ("dot" . 0.5) ("dot" . 0.75))
  	}
