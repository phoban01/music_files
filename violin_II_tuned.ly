violin_II_tuned = { 
	  	...
	  	\afterGrace \ppos #0.75 c'16 \p  \glissando {\ppos #0.2 c'8}
	  	r8
	  	\switch-staff \normal_staff
	  	\set Staff.forceClef = ##t
	  	\diamonds c'8 ] \p \< \glissando
	  	%%%%%%%%%% measure 4 %%%%%%%%%%
	  	\time 2/8
	  	\tuplet 3/2 {
	  		\glissSkipOn 
	  	...
	  	\time 4/4
	  	\diamonds
	  	f'4 \glissando \glissSkipOn \afterGrace a'4 {\glissSkipOff c''8}
	  	r2
	  	%%%%%%%%%% measure 6 %%%%%%%%%%
	  	\time 4/4
	  	<<{
		...
		\set glissandoMap = #'((0 . 0) (1 . 1) (2 . 2) (3 . 3))  
	  	...
	  	%%%%%%%%%% measure 8 %%%%%%%%%%
	  	\time 3/4
	  	<<{\glissSkipOff \diamonds <d' gses' dqf'' aqf''>4} \\ {\hideNotes \tweak #'stencil ##f \tuplet 3/2 {r8\mf r8\f\> \afterGrace r8 {r8\pp}} \unHideNotes}>>
	  	\afterGrace <gses' dqf''>8 \p \< \glissando {<ees' aqs'>8 \mf}
	  	\circles \afterGrace d'16 \p \> \glissando {dqs'8 \ppp}
	  	...
	  	r4 \tuplet 5/4 {
	  		\circles
	  		\afterGrace bqf8 \mp [ \glissando {bes}
	  		r16 \afterGrace dqs''16. \p \> \glissando {cs''8 \pp} r32 ]
	  	}
	  	%%%%%%%%%% measure 10 %%%%%%%%%%
	  	\time 5/4
	  	...
	  	\set Staff.forceClef = ##t
	  	\circleheads
	  	\ppos #0.2 c'4 \pp \glissando \glissSkipOn \ppos #0.5 c'4 
	  	\ppos #0.5 c'4 \< \afterGrace \ppos #0.5 c'4 \mp \> {\glissSkipOff \ppos #0.75 c'8 }
	  	%%%%%%%%%% measure 11 %%%%%%%%%%
	  	\time 4/8
	  	\ppos #0.75 c'4 \ppp ~ \ppos #0.75 c'4 ~ 
	  	%%%%%%%%%% measure 12 %%%%%%%%%%
	  	\time 5/4
	  	\tuplet 3/2 {
	  		\ppos #0.75 c'4 \ppos #0.75 c'8	~ \<
	  	} \afterGrace \ppos #0.75 c'8. [ {s8\ff} r16 ]
	  	\switch-staff \normal_staff
	  	\circles
	  	...
	  	\tuplet 3/2 {
	  		...
	  		\circleheads
	  		\niente
	  		\ppos #0.75 c'16 \f \glissando \afterGrace \ppos #0.3 c'16 \glissando {\ppos #0.75 c'8}
	  	}
	  	%%%%%%%%%% measure 14 %%%%%%%%%%
	  	\time 3/8
	  	\body-clef #'fingerboard-small
	  	\set Staff.forceClef = ##t
	  	\ppos #0.75 c'8 \p \glissando \ppos #0.4 c'8 \glissando \ppos #0.9 c'8 \glissando \glissSkipOn
	  	%%%%%%%%%% measure 15 %%%%%%%%%%
	  	\time 4/4
	  	...
	  	\tuplet 3/2 {
	  		...
	  		<<
	  			{\afterGrace bqs16 \glissando {bes8} r8}\\{\niente s32 \< \niente \afterGrace s32 \pp \> {s8\!}}
	  		>>
	  	}
	  	r8  [ r32 \afterGrace cqf'''16. ] \p \> \glissando {b''8 \ppp}
	  	%%%%%%%%%% measure 17 %%%%%%%%%%
	  	\time 4/8
	  	\diamonds
	  	\tuplet 6/4 {
	  		d'4 \ppp \< \circles bqf'16 \mf ( dqf''16)
	  	}
	  	...
	  	<<
	  	{
	  		\niente \circles <f'\harmonic e''>4  \glissando 
		  	\tuplet 3/2 {
		  	...
		  	\tuplet 3/2 {
		  		...
		  		\set Staff.forceClef = ##t
		  		\tuplet 3/2 {
		  			\ppos #0.2 c'16 \mf \glissando \ppos #0.75 c'16 \glissando \afterGrace \ppos #0.2 c'16 \glissando {\ppos #0.75 c'8}
		  		}
		  	}
		} \\
		{	
	  	...
	  	\niente 
	  	\squares <a'' aqs''>8 ~ ] \< <a'' aqs''>8. \pp \tuplet 3/2 {g''32 g'' g''}
	  	%%%%%%%%%% measure 25 %%%%%%%%%%
	  	\time 5/4
	  	r8 [ \niente \diamonds \ottava #1 b'''8 ] \< \glissando \glissSkipOn %>
	  	...
	  	<<{
	  		...
	  		\afterGrace <bf fs' d'' eqs''>2 \effort mf \glissando 
	  	...
	  	%%%%%%%%%% measure 29 %%%%%%%%%%
	  	\time 3/8
	  	\diamonds <e'' e'''>16 [ \ff r16 ] r8
	  	\squares <bf fs' d'' eqs''>8 \pp ~
	  	%%%%%%%%%% measure 30 %%%%%%%%%%
	  	\time 4/4
	  	<bf fs' d'' eqs''>4 ~ <bf fs' d'' eqs''>8 ~ \<  <bf fs' d'' eqs''>8 ~ \mf \>  <bf fs' d'' eqs''>4 \p ~ <bf fs' d'' eqs''>4 ~
	  	%%%%%%%%%% measure 31 %%%%%%%%%%
	  	\time 4/4
	  	<bf fs' d'' eqs''>8 \< ~ <bf fs' d'' eqs''>8 \mf \> ~ <bf fs' d'' eqs''>4 \p ~ <bf fs' d'' eqs''>4 ~ <bf fs' d'' eqs''>8. \< ~ 
	  	\afterGrace <bf fs' d'' eqs''>16 \f \> {s8\pp}
	  	%%%%%%%%%% measure 32 %%%%%%%%%%
	  	\time 5/4
	  	<bf fs' d'' eqs''>8  ~ <bf fs' d'' eqs''>8 \< ~ <bf fs' d'' eqs''>4:32 \mf \> ~ <bf fs' d'' eqs''>4 \pp ~ <bf fs' d'' eqs''>4 ~ <bf fs' d'' eqs''>4 ~ \<
	  	%%%%%%%%%% measure 33 %%%%%%%%%% 
	  	\time 4/4
	  	<bf fs' d'' eqs''>4 \mp ~ <bf fs' d'' eqs''>4 \sub_pp ~ <bf fs' d'' eqs''>4 ~ <bf fs' d'' eqs''>8 ~ <bf fs' d'' eqs''>8 ~
	  	%%%%%%%%%% measure 34 %%%%%%%%%%
	  	\time 6/4
	  	<bf fs' d'' eqs''>8 ~ <bf fs' d'' eqs''>8 ~ <bf fs' d'' eqs''>8 \mp ~ <bf fs' d'' eqs''>8 ~ \pp
	  	\tuplet 3/2 {
	  		<bf fs' d'' eqs''>8 ~ <bf fs' d'' eqs''>8 \mf ~ <bf fs' d'' eqs''>8 \pp ~
	  	} <bf fs' d'' eqs''>4 ~ <bf fs' d'' eqs''>4 ~ <bf fs' d'' eqs''>8 ~ <bf fs' d'' eqs''>8:64 \mf ~
	  	%%%%%%%%%% measure 35 %%%%%%%%%%
	  	\time 3/8
	  	\glissSkipOff \niente \afterGrace <bf fs' d'' eqs''>16 [ \> {s8\!} r16 ]  r16 [ \diamonds <e'' e'''>16  \f 
	  	\circles \niente \flare_width \afterGrace <e'' eqf''>8 ] \< {s8 \flare_sfz} %>
	  	%%%%%%%%%% measure 36 %%%%%%%%%%
	  	\time 5/4
	  	r4 r4 \ottava #2 \diamonds \niente b''''4 \< \glissando \ottava #0 \glissSkipOn g''4 \pp g''4
	  	%%%%%%%%%% measure 37 %%%%%%%%%%
	  	\time 5/4
	  	g''4 
	  	g''4 \glissSkipOff 
...
% 	  	\wavy_vibrato #1.5 
	  	...
	  	%%%%%%%%%% measure 38 %%%%%%%%%%
	  	\time 2/8
	  	r32 \niente \afterGrace d'''8.. \< \glissando {f''8 \f}
	  	%%%%%%%%%% measure 39 %%%%%%%%%%
	  	\time 4/4
	  	r8 \tuplet 3/2 {
	  			r8 [ <e'' e'''>16  \f ]
	  	}
	  	\afterGrace e'''8. [ \mf  \> \glissando {f''8 \pp } r16 ]
	  	r4 r4
	  	%%%%%%%%%% measure 40 %%%%%%%%%%
	  	\time 8/4
	  	r2 r2 r2 r8 \squares \niente <bf fs' d'' eqs''>8 ~ \<  <bf fs' d'' eqs''>4 \pp
	  	%%%%%%%%%% measure 41 %%%%%%%%%%
	  	\time 6/4
	  	...
	  	\tuplet 3/2 {
	  		<bf fs' d'' eqs''>8 <bf fs' d'' eqs''>4 ~ \sub_p
	  	}
	  	...
	  	\tuplet 7/4 {
	  		\diamonds
	  		\niente	
	  		fs''64 [ \< c'' fs' gqs \fposs \> fs' c'' fs'' ]
	  	}
	  	<as' f''>8 [ \pp \< \glissando \afterGrace <f'' d'''>16 ] \mf \> \glissando {<as' f''>8 \pp}
	  	%%%%%%%%%% measure 44 %%%%%%%%%%
	  	\time 5/4
	  	\circles
	  	\niente
	  	<gqs'' af''>4 \< \glissando \glissSkipOn g''4 g''4 \mf \> g''8 \pp g''8 \< \glissSkipOff 
	  	\niente \afterGrace <e'' fqf''>4 \mp \> {s8\!}
	  	%%%%%%%%%% measure 45 %%%%%%%%%%
	  	\time 5/8
	  	\switch-staff \body_staff
	  	\body-clef #'bow-area-small
	  	r8 \set Staff.forceClef = ##t
	  	\ppos #0.75 c'4 \ppos #0.75 c'4 \glissando
	  	%%%%%%%%%% measure 46 %%%%%%%%%%
	  	\time 2/8
	  	\ppos #0.75 c'4
	  	%%%%%%%%%% measure 47 %%%%%%%%%%
	  	...
	  	r4  
	  	<<
	  		{\afterGrace cs'8 \glissando {cqs'8}} \\ {\niente s16 \< \niente \afterGrace s16 \p \> {s8\!}}
	  	>>
	  	r16 \niente <cqs' fqs'\harmonic>16 \< ~ <cqs' fqs'\harmonic>4 \ppp ~
	  	%%%%%%%%%% measure 51 %%%%%%%%%%
	  	\time 3/8
	  	<cqs' fqs'\harmonic>8 \<

	  	\afterGrace f'4 \ff ^\tilt_bow ^\altosulpont ^\markup \string-numbers #'( "IV" 3 0) \glissando {fs'8}
	  	%%%%%%%%%% measure 52 %%%%%%%%%%
	  	\time 4/8
	  	\tuplet 3/2 {
	  		r8 \niente bqf'4 \< \glissando \glissSkipOn
	  	...
	  	%%%%%%%%%% measure 55 %%%%%%%%%%
	  	\time 3/4
	  	\afterGrace <d' gqs'>4 \mp \glissando {<ds' aqf'>8}
	  	\diamonds <e' b'>16 \< [ \glissando <c' g'> \glissando <e' b'> \glissando <c' g'>16 \f ]
	  	\circles
	  	<cqs' fqs'\harmonic>4 ~ \sub_ppp
	  	%%%%%%%%%% measure 56 %%%%%%%%%%
	  	\time 3/8
	  	<cqs' fqs'\harmonic>4. ~
	  	%%%%%%%%%% measure 57 %%%%%%%%%%
	  	\time 4/8
	  	<cqs' fqs'\harmonic>16 ~ 
	  	\flare_width <cqs' fqs'\harmonic>8. \<  ~ \afterGrace <cqs' fqs'\harmonic>8 {s8 \flare_sfz} <cqs' fqs'\harmonic>8 ~ \ppp
	  	%%%%%%%%%% measure 58 %%%%%%%%%%
	  	\time 5/16
	  	<cqs' fqs'\harmonic>4 \< \glissando <c' f'\harmonic>16 ~ \p \>
	  	%%%%%%%%%% measure 59 %%%%%%%%%%
	  	\time 3/8
	  	...
	  	\body-clef #'fingerboard-small
	  	\set Staff.forceClef = ##t
	  	\ppos #0.4 c'8 \effort mf \glissando \glissSkipOn \ppos #0.5 c'8 
	  	\ppos#0.65 c'8 \afterGrace \ppos #0.7 c'32 {\glissSkipOff \ppos #0.75 c'8} \ppos #0.75 c'32 \effort "f" r16
	  	\switch-staff \normal_staff
	  	...
	  	\set Staff.forceClef = ##t
	  	\circleheads
	  	\afterGrace \ppos #0.3 c'8 \pp [ \glissando {\ppos #0.6 c'8} r16 ]
	  	%%%%%%%%%% measure 63 %%%%%%%%%%
	  	\time 4/4
	  	\switch-staff \normal_staff
	  	\squares gqs4 \p \< ~ \afterGrace gqs4 {s8\mf} 
	  	\diamonds 
	  	\afterGrace g''8 \f [ \glissando {c'''8} r8 ]
	  	<<
	  		{r16 [ \circles cqs'8. ]}
	  		\\
	  	...
	  	\time 5/8
	  	\diamonds 
	  	\niente c'4 \< ~ c'8 \pp \glissando \glissSkipOn c'8 \< \niente \afterGrace c'8 \mp \> {\glissSkipOff bf8 \!}
	  	%%%%%%%%%% measure 65 %%%%%%%%%%
	  	\time 5/16
	  	\circles
	  	r8 r16 [ \niente  dqf'' \< \glissando cs''16 \p ] \glissando
	  	%%%%%%%%%% measure 66 %%%%%%%%%%
	  	\time 2/8
	  	<<{dqf''4} \\ {s8 \niente \afterGrace s8 \> {s8\!}}>>
	  	%%%%%%%%%% measure 67 %%%%%%%%%%
	  	\time 5/16
	  	<bqf'' eqf'''\harmonic>4 \pp ~ <bqf'' eqf'''\harmonic>16
	  	%%%%%%%%%% measure 68 %%%%%%%%%%
	  	\time 3/4
	  	<bqf'' eqf'''\harmonic>8.  <bqf'' eqf'''\harmonic>16 ~ \mfpp
	  	<bqf'' eqf'''\harmonic>2 
	  	%%%%%%%%%% measure 69 %%%%%%%%%%
	  	\time 4/4
	  	\tuplet 10/8 {
	  		r16 [ 
	  		\niente
	  		eqs''16 \< ~ <eqs'' aqs''\harmonic>8 <b'~ e''\harmonic> b' ~ <b' fs'~> 
	  		<fs' as'\harmonic> ~ <c' fs' as'\harmonic>8 ~ <c' fs' as'\harmonic>8 <bf f'\harmonic>16 bf16 <fs' b'\harmonic>8 \fposs ] 
	  	}
	  	%%%%%%%%%% measure 70 %%%%%%%%%%
	  	\time 5/16
	  	\tuplet 21/20 {
	  	...
	  	\circles <a'' aqs''>8 \f \glissando \glissSkipOn g''16 g''16 \glissSkipOff <f'' fqs''>16 \glissando 
	  	\glissSkipOn g''16  \glissando \glissSkipOff <g'' aqf''>16 \glissando \glissSkipOn \afterGrace g''16 \< \glissando {\glissSkipOff <g'' gqs''>8}

	  	\tuplet 13/12 {
	  		eqs''64 [  b' \diamonds fs' \circles bf \fposs fs' b' \diamonds eqs'' b' fs' \circles bf \diamonds fs' \circles b' e'']
	  	}
	  	%%%%%%%%%% measure 72 %%%%%%%%%%
	  	\time 6/4
	  	\tuplet 3/2 {
	  		r8 <d'' dqs''>4 \f \< \glissando \glissSkipOn
	  	}
	  	\tuplet 3/2 {
	  	...
	  	\slurDashed
	  	\tuplet 3/2 {
	  		cqs'4 ( \circles cqs'4) \mp \squares  cqs'8 \sub_pp r8
	  	}
	  	%%%%%%%%%% measure 80 %%%%%%%%%%
	  	\time 4/8
	  	\tuplet 3/2 {
	  	...
	  	\afterGrace a'8 \p \< \glissando {fs''8 \mf} e''8 
	  	fqs'' \afterGrace g' \p \< \glissando {e''8 \mf}
	  	%%%%%%%%%% measure 85 %%%%%%%%%%
	  	\time 3/8
	  	c'''16 \p \> b'' bqf'' \diamonds a'' aqs'' b''
	  	%%%%%%%%%% measure 86 %%%%%%%%%%
	  	\time 3/4
	  	\tuplet 6/4 {
...
% 	 	\wavy_line #1
	 	...
	 	\set Staff.forceClef = ##t
	 	\circleheads	 	
	 	\ppos #0.6 c'16 \mf \glissando \afterGrace \ppos #0.2 c'16 \glissando {\ppos #0.75 c'8}
	 	r8
	 	%%%%%%%%%% measure 102 %%%%%%%%%%
	 	\time 4/4
	 	\switch-staff \normal_staff
...
% 	 	\wavy_line #1.25
	 	...
	 	\set Staff.forceClef = ##t
	 	\circles
	 	\ppos #0.75 c'16 \mf \glissando \afterGrace \ppos #0.25 c'16 ] \glissando {\ppos #0.75 c'8}
	 	%%%%%%%%%% measure 106 %%%%%%%%%%
	 	\time 5/8
	 	s2 s8
	 	...
	 	\flare_width \afterGrace \ppos #0.85 c'8. \< ] {s8 \flare_sfz}
	 	%%%%%%%%%% measure 107 %%%%%%%%%%
	 	\tieNeutral
	 	\time 5/4
	 	r4 r4 r8 \circles 
	 	...
	 	bqf'''16 [ \mp bqf'''16 ] ~ \pp \<
	 	\tuplet 3/2 {
	 		\niente bqf'''8 [ \p \> \afterGrace bef'8 {s8\!} r16 cses''16 \pp \< ] \glissando 
	 	}
	 	\squares d''8. \mf \circles cs''16 \mp \glissando
	 	%%%%%%%%%% measure 108 %%%%%%%%%%
	 	\time 5/8
	 	\niente \glissSkipOn \afterGrace e''8 \> [ {\glissSkipOff def''8 \!} r8 ]
	 	\switch-staff \body_staff
	 	\body-clef #'fingerboard-small
	 	r8
	 	\set Staff.forceClef = ##t 
	 	...
	 	%%%%%%%%%% measure 119 %%%%%%%%%%
	 	\time 2/4
	 	r8. \ppos #0.75 c'16 \effort mf \glissando \glissSkipOn \ppos #0.6 c'8 \ppos #0.4 c'8
	 	%%%%%%%%%% measure 120 %%%%%%%%%%
	 	\time 2/8
	 	\glissSkipOff
	 	...
	 	\set Staff.forceClef = ##t
	 	\circleheads
	 	\ppos #0.75 c'4 \effort mf \glissando \glissSkipOn \ppos #0.5 c'8 \afterGrace \ppos #0.5 c'8 {\glissSkipOff \ppos #0.2 c'8} r4
	 	%%%%%%%%% measure 126 %%%%%%%%%%
	 	\time 5/8
	 	\niente \flare_width
	 	\afterGrace \ppos #0.5 c'8. \< {s8 \flare_sfz} r16 \ppos #0.3 c'32 \mf \ppos #0.3 c'16. \glissando \glissSkipOn c'8 c'8 
	 	%%%%%%%%%% measure 127 %%%%%%%%%%
	 	\time 5/4
	 	\afterGrace \ppos #0.5 c'8 {\glissSkipOff c'8} r8
	 	\ppos #0.3 c'4 \p \< \glissando \glissSkipOn \afterGrace \ppos #0.5 c'8 \mf \> {\glissSkipOff \ppos #0.65 c'8 \p} r8
	 	\afterGrace \ppos #0.75 c'16 \glissando {\ppos #0.2 c'8} r8.
	 	\switch-staff \normal_staff
	 	\set Staff.forceClef = ##t 
	 	<<
	 		{\circles \afterGrace gqs'4 \glissando {gqf'8}} \\ {\niente s8 \< \afterGrace s8 \p \> {s8\!} }
	 	>>
	 	%%%%%%%%%% measure 128 %%%%%%%%%%
	 	\time 2/4
	 	\switch-staff \body_staff
	 	...
	 	\circleheads
	 	\tuplet 3/2 {
	 		r4 \set Staff.forceClef = ##t \ppos #0.65 c'8 \p \glissando
	 	}
	 	...
	 	r16 [
	 	\set Staff.forceClef = ##t
	 	\niente \diamonds \afterGrace g'8. ] {s8\p}
	 	\switch-staff \body_staff
	 	\body-clef #'fingerboard-small
	 	\set Staff.forceClef = ##t
	 	\circleheads
	 	\ppos #0.75 c'4 \mf \glissando
	 	%%%%%%%%%% measure 135 %%%%%%%%%%
	 	\time 2/8
	 	...
	 	\afterGrace \ppos #0.75 c'8 \< {s8\sf}
	 	\ppos #0.75 c'16 \glissando 
	 	\afterGrace \ppos #0.4 c'16 \mf \glissando {\ppos #0.75 c'8}
	 	%%%%%%%%%% measure 137 %%%%%%%%%%
	 	\time 5/8
	 	...
	 	\niente
	 	<g'~ g'>4 \< \glissando \glissSkipOn a'4 \afterGrace a'4 \p \> {\glissSkipOff <g' af'>8 \pp ~}
	 	%%%%%%%%%% measure 139 %%%%%%%%%%
	 	\time 4/8
	 	<g'~ af'>4 \< \glissando <g' gqs'>8 ~ \mp \niente \afterGrace <g' gqs'>8 \> {s8\!}
	 	%%%%%%%%%% measure 140 %%%%%%%%%%
	 	\time 4/8
	 	...
	 	\diamonds \transpose eqs'' aqs'' {
	 		\niente <bf ees' aqs' eqs''>8 ] \< \glissando } 
	 	...
	 	\tieUp
	 	\transpose eqs'' fs'' {<\single\hideNote bf \single\hideNote ees' \single\hideNote aqs' eqs'' ~ >8 \p}
	 	\tieUp
	 	\set glissandoMap = #'((1 . 1))
	 	\circles \niente \afterGrace <fs''~ e''>4 \> \glissando {<fs'' dqs'' >8 \!} r4
	 	%%%%%%%%%% measure 143 %%%%%%%%%%
	 	\time 2/8
	 	r4
	 	\tieNeutral
	 	...
	 	\time 3/4
	 	\set glissandoMap = #'((0 . 0 ) (1 . 1) (2 . 2) (3 . 3))
	 	r4 r8. [ \niente <bf ees' aqs' eqs''>16 \< ] ~  <bf ees' aqs' eqs''>8 \p [ ~
	 	...
	 	\afterGrace 
	 		...
	 		{<bf ees' aqs' eqs''>8 \!}
	 		\afterGrace c'16 \pp [ \glissando {cs'8} 
	 		\niente \diamonds d'8. ] \< \glissando
	 	%%%%%%%%%% measure 146 %%%%%%%%%%
	 	\time 5/8
	 	\glissSkipOn d'8 \mp \glissSkipOff <c' fs'>8 \glissando \glissSkipOn c'8 c'8 
	 	...
	 	\tieDown
	 	\set glissandoMap = #'((1 . 1))
	 	\afterGrace <d'~ ef'>4 ) \mp \glissando {<d'~ dqs'>8}
	 	...
	 	\flare_width \afterGrace  e''''4 \f \< \glissando {\ottava #0 cs''8 \flare_sfz}
	 	%%%%%%%%%% measure 150 %%%%%%%%%%
	 	\time 3/4
	 	\tieNeutral
	 	\circles
	 	r8.. [ \niente gs''32 \< ~ ] gs''16 \p [ cs''16 \mf \niente \afterGrace fs''8 \> ] \glissando {gef''8 \!}
	 	\niente gs'4 \< \glissando
	 	%%%%%%%%%% measure 151 %%%%%%%%%%
	 	\time 4/4
	 	\glissSkipOn \niente \afterGrace b'8 [ \p \> \glissando {\glissSkipOff aef'8 \!} 
	 	\niente \afterGrace gqs''8 ] \<  \glissando {g''8 \mf \>}
	 	...
	 	\time 2/8
	 	\tuplet 6/4 {
	 		r16 [ \niente g''8 \< \glissando \glissSkipOn \niente g''8 \p \> \glissSkipOff \afterGrace bef''16 ] {s8\!}
	 	}
	 	%%%%%%%%%% measure 153 %%%%%%%%%%
	 	\time 3/4
	 	r8. <b'' e'''\harmonic>16 \pp
	 	r4 \niente \diamonds \afterGrace g'4 \< {s8\f}
	 	%%%%%%%%%% measure 154 %%%%%%%%%%
	 	\time 4/4
	 	r16 \circles \niente gs''8. \< ~ gs''4 \p ~ gs''16 ~ <gs'' cs'''\harmonic>8. \> ~ <gs'' cs'''\harmonic>4 \ppp ~
	 	%%%%%%%%%% measure 155 %%%%%%%%%%
	 	\time 3/8
	 	<gs'' cs'''\harmonic>4 \< ~ \afterGrace <gs'' cs'''\harmonic>8 \mf \> {s8\!}
	 	%%%%%%%%%% measure 156 %%%%%%%%%%
	 	\time 5/8
	 	r16. \flare_width <cs'' fs''\harmonic>32 \p \< ~ \afterGrace <cs'' fs''\harmonic>8 {s8 \flare_sfz} r8
	 	\diamonds
	 	\flare_width \afterGrace d''8 [ \p \< {s8 \flare_sfz} r8]
	 	%%%%%%%%%% measure 157 %%%%%%%%%%
	 	\time 4/4
	 	r16 [ \niente \afterGrace d''8. \< ] {s8 \p} 
	 	r8. [ g'16 ] \p
	 	r4 r4
	 	%%%%%%%%%% measure 158 %%%%%%%%%%
	 	\time 5/4
	 	<<
	 		...
	 		{s16 \niente s16 \< s16 \mp \niente \afterGrace s16 \> {s8\!}}
	 	>>
	 	r16 [ \diamonds b''8. \ppp ~ ] b''4 ~ b''4 ~ b''8 ~ \afterGrace b''8 \< {s8\p}
	 	%%%%%%%%%% measure 159 %%%%%%%%%%
	 	\time 3/4
	 	...
	 	\set Staff.forceClef = ##t
	 	\circleheads
	 	\ppos #0.2 c'4 \pp \glissando _\markup {
	 			\center-align
	 			\center-column {
	 				\small \italic "au sillet"
	 				\fingering-diagram #'(("di" . 0.5) ("di" . 0.5) ("di" . 0.5) ("di" . 0.5))
	 	...
	 	\time 5/8
	 	\glissSkipOn
	 	\ppos #0.3 c'8 \ppos #0.4 c'8 \ppos #0.5 c'8  \ppos #0.6 c'8 \niente \afterGrace \ppos #0.6 c'8 \> {\glissSkipOff \ppos #0.75 c'8\!}
	 	%%%%%%%%%% measure 161 %%%%%%%%%%
	 	\time 5/4
	 	\switch-staff \normal_staff
	 	\set Staff.forceClef = ##t
	 	r8 [ c'8 \ppp ~ ] c'4 ~ \tuplet 3/2 {
	 	...
	 	%%%%%%%%%% measure 167 %%%%%%%%%%
	 	\time 5/8
	 	\ppos #0.2 c'8 ~ \ppos #0.2 c'8 ~ \ppos #0.2 c'8 ~ \ppos #0.2 c'16 ~ \ppos #0.2 c'16 \mf ]  r8
	 	%%%%%%%%%% measure 168 %%%%%%%%%%
	 	\time 2/4
	 	\switch-staff \normal_staff
	 	\circles
	 	r4 r8. [ \ottava #2 
% 	 	\wavy_vibrato #1.25 
	 	\flare_width \niente \afterGrace b''''16 \< ] \glissando {\ottava #0 \hideNotes b'''8 \flare_sf \unHideNotes}
	 	%%%%%%%%%% measure 169 %%%%%%%%%%
	 	\time 4/4
	 	r4 
	 	\switch-staff \body_staff
	 	...
	 	%%%%%%%%%% measure 171 %%%%%%%%%% 
	 	\time 3/8
	 	\ppos #0.2 c'8 [ ~ \ppos #0.2 c'8 ~ \ppos #0.2 c'16 \mf r16 ]
	 	%%%%%%%%%% measure 172 %%%%%%%%%% 
	 	\time 4/4
	 	\switch-staff \normal_staff 
	 	r16 [ 
	 	\set Staff.forceClef = ##t
	 	\circles
	 	\ottava #2 b''''8. ] \fposs \glissando \glissSkipOn  b'4 b'4 b'4
	 	%%%%%%%%%% measure 173 %%%%%%%%%%
	 	\time 4/4
	 	b''32 b''8.. b''4 \glissSkipOff 
% 	 	\wavy_vibrato #1.25 
	 	\flare_width \afterGrace e'''8 \p  \< [ \glissando {\hideNotes e'''8 \flare_sfz \unHideNotes} r8 ]
	 	\ottava #0
	 	\switch-staff \body_staff
	 	\body-clef #'fingerboard-small
	 	\set Staff.forceClef = ##t
	 	\circleheads
	 	\ppos #0.2 c'8.:64 \p [  _\markup {
	 			\center-align
	 			\center-column {
	 				\small \italic "au sillet"
	 				\fingering-diagram #'(("di" . 0.5) ("di" . 0.5) ("di" . 0.5) ("di" . 0.5))
	 	...
	 	%%%%%%%%%% measure 174 %%%%%%%%%%
	 	\time 4/4 
	 	r4 \ppos #0.2 c'4 \p ~ \ppos #0.2 c'8. [ r16 ] r4
	 	%%%%%%%%%% measure 175 %%%%%%%%%%
	 	\time 5/8
	 	r4 r4.
	 	%%%%%%%%%% measure 176 %%%%%%%%%%
	 	\time 3/4
	 	r16 [ \ppos #0.2 c'8. \mp ] ~ \ppos #0.2 c'8[ r8]
	 	r4
	 	%%%%%%%%%% measure 177 %%%%%%%%%%
	 	\time 4/4
	 	\switch-staff \normal_staff
	 	...
	 	%%%%%%%%%% measure 179 %%%%%%%%%%
	 	\time 4/4 
	 	<d' ef'>4 \ppp ~ <d' ef'>4 ~ <d' ef'>4 \< ~ <d' ef'>4 \mf ~
	 	%%%%%%%%%% measure 180 %%%%%%%%%%
	 	\time 5/8
	 	\niente \afterGrace <d' ef'>8. \> [ {s8\!} r16 ] r16 [ \ottava #2 
% 	 	\wavy_vibrato #1.25 
