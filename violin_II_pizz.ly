...
\set baseMoment = #(ly:make-moment 1/8)
 %%%%%%%% ============= measure 25 ============= %%%%%%%% 
  ...
  %%%%%%%% ============= measure 26 ============= %%%%%%%% 
 	\time 5/4
 	\arp_pizz_head "I" "IV" \ppos #0.65 c16. [ \p
...
violin_II_pizz_left_one = { 
	...
	\ppos #0.25 c16 ] \glissando
	 ...
	 \tuplet 5/4 {
	 	...
	 	\afterGrace \ppos #0.25 c16 ] \glissando {\slash_grace \ppos #0.8 c8}
	 }
}
...
r8
 ...
 %%%%%%%% ============= measure 75 ============= %%%%%%%% 
  ...
  \pizz_head "III IV" \ppos #0.3 c8 \mp
 ...
 %%%%%%%% ============= measure 77 ============= %%%%%%%% 
  ...
  \pizz_head "II III" \ppos #0.25 c8 \p
  r8 ]
 ...
 %%%%%%%% ============= measure 78 ============= %%%%%%%% 
  ...
  \pizz_head "III" \ppos #0.35 c16 \p
  \pizz_head "I II" \ppos #0.25 c8 \mf
  r8
  r16
